...
- docs/archive/handover/HANDOVER_2025-01-09.md（前回セッションの引き継ぎ）
...
- docs/specs/REQUIREMENTS.md の「VoiceSession（通話録音 - Phase 2）」セクション
- docs/planning/DEVELOPMENT_PLAN.md の「Step 3: 通話録音・文字起こし」セクション
